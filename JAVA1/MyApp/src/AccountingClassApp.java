class Accounting{
    public static double ValueOfSupply; // main 바깥쪽에서 선언되었기 때문에 main에서도, getvat 안에서도 적용 가능. 필드라 한다.
...
public class AccountingClassApp {
    ...
    public static void main(String[] args) {
        Accounting.ValueOfSupply = 230300.0;
        Accounting.vatRate = 0.1; // 전역변수 필드 선언
